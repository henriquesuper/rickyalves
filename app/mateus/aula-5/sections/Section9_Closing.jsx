    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        {journeyLessons.map((lesson) => {
          const isCompleted = lesson.id <= 5;
          const isCurrent = lesson.id === 5;
          const phaseColor =
...
export function Section9_Closing() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-14 text-center">
      ...
      >
        A lei agora não está em cima de você te esmagando.
        <br />
        Está debaixo de você te sustentando.
      </motion.p>
