...
function QuizQuestionSlide({ questionIndex, slideLabel }) {
...
export default function Slide05_Pergunta2() {
    return <QuizQuestionSlide questionIndex={1} />;
}
