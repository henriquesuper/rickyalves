...
export const colors = {
    // Primárias do Dossiê
    kraft: '#F5E6C8',           // Fundo principal — slides AT
    slateBlue: '#1B3A5C',      // Títulos, stamps VERIFICADO
    amber: '#B07D2E',          // Subtítulos, bordas de caso, EM DEBATE
    mossGreen: '#2E6B4F',      // Confirmações, evidências positivas
    wineRed: '#8B1A2E',        // Tensões, debates não resolvidos
    ...
    textMuted: '#999999',      // Rodapé

    // Dourado (continuidade com lições anteriores)
    goldAged: '#C9A962',
    goldBright: '#D4AF37',

    // Stamps
    stampVerified: '#2E6B4F',   // Verde-musgo
    stampDebate: '#B07D2E',     // Âmbar
    stampUnknown: '#6B6B6B',    // Cinza
    stampLost: '#555555',       // Cinza escuro
    stampConcluded: '#2E6B4F',  // Verde conclusão

    // Botões do Quiz
    quizConcordo: '#2E6B4F',   // Verde-musgo
    quizDepende: '#B07D2E',    // Âmbar
