...
function movementFor(index0) {
    if (index0 <= 4)  return { roman: 'I',   label: 'Salmo 88',           accent: colors.wine };
    if (index0 <= 11) return { roman: 'II',  label: 'Jó 1—2',             accent: colors.lapis };
    if (index0 <= 28) return { roman: 'III', label: 'Exílio Babilônico',  accent: colors.lapis };
    if (index0 <= 34) return { roman: 'IV',  label: 'A Cruz',             accent: colors.wine };
    return { roman: 'V', label: 'Solidão e Direção', accent: colors.gold };
}

export default function Licao16Viewer() {
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col items-center">
                    ...
                    >
                        Lição 16 · setas ↕ para navegar · &quot;F&quot; fullscreen
                    </span>
                </div>
                <button
                    onClick={nextSlide}
