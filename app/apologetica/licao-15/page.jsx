...
export default function Licao15Viewer() {
    ...
    const isFinalArc = currentSlideIndex >= 10; // dourado-amanhecer ativo a partir do slide 11
    const advanceColor = isFinalArc ? colors.goldDawn : colors.inkAntique;
    const advanceTextColor = isFinalArc ? colors.parchment : colors.parchment;

    return (
        <div
            className="min-h-screen relative"
            style={{ background: colors.parchment, color: colors.inkAntique, fontFamily: fonts.body }}
        >
            ...
            <div
                ...
                style={{
                    ...
                    borderTop: `1px solid ${colors.inkMuted}30`,
            ...
            >
                <button
                    ...
                    style={{
                        ...
                        border: `1px solid ${colors.inkMuted}55`,
                ...
                <div className="flex flex-col items-center">
                    <span
                        ...
                        style={{
                            color: isFinalArc ? colors.goldDawn : colors.inkSoft,
                            fontFamily: fonts.body,
                            fontVariant: 'small-caps',
                        }}
                    >
                    ...
                    >
                        Lição 15 · setas ↕ para navegar · &quot;F&quot; fullscreen
                    </span>
                </div>
                <button
                    onClick={nextSlide}
                    ...
                    style={{
                        ...
                        color: advanceTextColor,
                        border: `1px solid ${advanceColor}`,
