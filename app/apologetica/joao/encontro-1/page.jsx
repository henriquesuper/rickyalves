...
function movementFor(index0) {
    if (index0 <= 21) return { roman: 'I',   label: 'O Prólogo',         accent: colors.lapis };
    if (index0 <= 33) return { roman: 'II',  label: 'Testemunhas',       accent: colors.gold };
    if (index0 <= 41) return { roman: 'III', label: 'Sinal e Templo',    accent: colors.wine };
    return            { roman: 'IV',  label: 'Nicodemos',         accent: colors.lapisDeep };
}
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col items-center">
                    ...
                    >
                        Encontro 1 · João 1–3 · setas ↕ para navegar · &quot;F&quot; fullscreen
                    </span>
                </div>
                <button
                    onClick={nextSlide}
