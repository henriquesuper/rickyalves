    ...
    return (
        <LabWrapper stratum="warning-filter">
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    Lentes calibradas. Aberrações identificadas.
                </motion.p>
                ...
                <motion.div
                    ...
                    style={{ background: `linear-gradient(to right, transparent, ${colors.lensPurple}, transparent)` }}
                />
