...
import { colors, getStratum, ShelfIndicator } from './slides/shared';

const slideKeys = Object.keys(Slides)
    .filter(key => key.startsWith('Slide'))
    .sort();

export default function Licao13Viewer() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden" style={{ background: colors.bgLibrary }}>
            ...
            <AnimatePresence>
                {showRefocus && (
                    <motion.div
                        ...
                        style={{ background: `${colors.bgLibrary}40` }}
                    />
                )}
            </AnimatePresence>

            <ShelfIndicator currentSlide={currentSlideIndex} totalSlides={totalSlides} />
            ...
            <div
                ...
                style={{
                    ...
                    borderTop: `1px solid ${colors.inkGold}25`,
            ...
            >
                <button
                    ...
                    style={{
                        background: colors.bgWood,
                        color: colors.textLight,
                        border: `1px solid ${colors.inkGold}35`,
                ...
                <div className="flex flex-col items-center">
                    <span className="text-sm font-semibold tracking-wider" style={{ color: colors.inkGold }}>
                        {displayNumber} / {totalSlides}
                    </span>
                    <span className="text-xs" style={{ color: colors.textMuted }}>
                        {currentStratum.label} · {currentStratum.mag} · Setas ↕ para navegar · &quot;F&quot; fullscreen
                    </span>
                </div>
                <button
                    onClick={nextSlide}
