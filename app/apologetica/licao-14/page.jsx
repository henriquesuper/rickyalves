...
import { colors, getStratum, OrbitIndicator } from './slides/shared';

const slideKeys = Object.keys(Slides)
    .filter(key => key.startsWith('Slide'))
    .sort();

export default function Licao14Viewer() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden" style={{ background: colors.bgVoid }}>
            ...
            <AnimatePresence>
                {showRefocus && (
                    <motion.div
                        ...
                        style={{ background: `${colors.bgVoid}40` }}
                    />
                )}
            </AnimatePresence>

            <OrbitIndicator currentSlide={currentSlideIndex} totalSlides={totalSlides} />
            ...
            <div
                ...
                style={{
                    ...
                    borderTop: `1px solid ${colors.haloGold}25`,
            ...
            >
                ...
                <div className="flex flex-col items-center">
                    <span className="text-sm font-semibold tracking-wider" style={{ color: colors.haloGold }}>
