# Solução de Problemas — Roteiro completo

> Aula do **Curso de Liderança** · ~1 hora · ~15 pessoas · Google Meet
> Público: equipe operacional de locadora de veículos (exit gate, balcão/atendimento, oficina/troca de óleo).
> Tom: "para a empresa, mas para a vida."

Este documento é a **fonte única do conteúdo** (o "artigo"). Os slides são a "manchete";
aqui mora o que se fala de verdade. Estrutura espelha o `notes.js` da Lição 9:

- **title** — título do slide
- **lead** — a batida do slide em uma frase
- **script** — o que dizer (parágrafos)
- **depth** — aprofundamentos densos (fonte, exemplo de locadora, ponte com tecnologia)
- **visual** — o esboço do slide (o que aparece na tela, componente, animação)

---

## A espinha

**Frase-âncora:** *"O problema que você vê quase nunca é o problema que você tem."*

**Tese em 3 frases** (abre e fecha a aula):
1. **Entenda antes de resolver** — reagir rápido ao sintoma errado custa caro.
2. **A causa raiz mora embaixo do primeiro "porquê"** — desça até ela.
3. **Resolver de verdade é fazer o problema não voltar** — e quase sempre passa por uma pessoa, não só por um processo.

**O método — os 6 P** (um por Movimento):
`Pausa → Pessoa → Problema → Porquê → Plano → Prevenir`
Os 5 primeiros resolvem o problema de hoje. O 6º — **Prevenir** — é o salto que separa um bom funcionário de um líder.
...
- **visual:** Tela escura (grafite). Título grande em sans moderna, centralizado. Subtítulo (frase-âncora) em itálico, na cor de destaque (âmbar). Linha fina âmbar abaixo. Rótulo pequeno no rodapé: "Curso de Liderança · Solução de Problemas".
...
- **visual:** Fundo escuro com leve textura. Frase grande no centro ("São 18h. A fila não anda."). A pergunta "O que você faz nos próximos 90 segundos?" aparece com atraso, em âmbar. Sensação de tensão (talvez um leve pulsar/relógio implícito). Sem listas.

## Slide 3 — A tese em 3 frases
...
- **depth:**
  - { label: "Por que a ordem importa", text: "Invertida, a tese vira o erro comum: agir primeiro, entender depois, e tratar o sintoma achando que resolveu. Mantida na ordem, ela é o evangelho da solução de problemas — e as três frases reaparecem no fecho da aula." }
- **visual:** Três frases empilhadas, numeradas (01, 02, 03), entrando uma por vez. Tipografia grande, muito espaço em branco. Número em âmbar, frase em off-white. Sóbrio e editorial.

## Slide 4 — O mapa: os 6 P
...
- **visual:** Os 6 P dispostos em linha (ou em forma de mão estilizada), cada um entrando em sequência, numerados I–VI. O 6º (Prevenir) destacado com cor/peso diferente ("o salto de liderança"). Funciona como índice visual da aula.

---

# MOVIMENTO I — PAUSA
*Não reaja ao sintoma.*

## Slide 5 — Abertura do Movimento I
- **title:** I · Pausa
...
- **visual:** Abertura de movimento: numeral romano "I" grande em âmbar, título "Pausa", subtítulo "Não reaja ao sintoma". Linha fina. Fundo escuro sólido.

## Slide 6 — O instinto que trai
...
- **visual:** Contraste visual entre "reagir" e "responder". Talvez duas colunas (Sintoma → reação impulsiva) vs (Pausa → resposta). Animação sutil de um "pulso" acelerado que se acalma.

## Slide 7 — O erro mais caro
...
- **visual:** Imagem-conceito: uma flecha rápida acertando o alvo errado. Frase forte "Resolver bem o problema errado" em destaque. Tom de alerta sóbrio.

## Slide 8 — A pausa de 3 segundos
...
- **visual:** Slide mais "quieto", respirável. Talvez um círculo que expande/contrai (respiração) com o texto "3 segundos". Ênfase em "Observa". Muito espaço negativo.
...
## Slide 9 — Abertura do Movimento II
- **title:** II · Pessoa
...
- **visual:** Abertura de movimento: "II", "Pessoa", subtítulo "Separe a pessoa do problema".

## Slide 10 — A pessoa não é o problema
...
- **visual:** Esquema visual: à esquerda "VOCÊ ⟷ PESSOA" (frente a frente, tom de conflito); à direita "VOCÊ + PESSOA → PROBLEMA" (lado a lado). Transição animada de um para o outro.

## Slide 11 — Emoção primeiro, fato depois
...
- **visual:** Duas etapas em sequência: "1. Emoção (acolher)" depois "2. Fato (resolver)". Talvez uma "onda" que se acalma. Destaque na frase-modelo "Eu entendo... vamos olhar isso juntos."

## Slide 12 — Pressuposto de boa intenção
...
- **visual:** Duas "lentes" sobre a mesma cena: lente da má-fé (escura) vs lente generosa (clara). Mostrar como a mesma situação muda de cor conforme a interpretação.

## Slide 13 — Pergunta para a turma (Pessoa)
...
- **visual:** Slide de pergunta: card centralizado, borda âmbar em cima e embaixo, pergunta grande em itálico. Rótulo "Pergunta para a turma".

---

# MOVIMENTO III — PROBLEMA
*Qual é o problema de verdade?*

## Slide 14 — Abertura do Movimento III
- **title:** III · Problema
...
- **visual:** Abertura de movimento: "III", "Problema", subtítulo "Qual é o problema de verdade?".

## Slide 15 — Sintoma não é problema
...
- **visual:** Diagrama iceberg: ponta visível = "sintoma" (a reclamação), parte submersa = "problema/causa". Texto curto, imagem fala.

## Slide 16 — Definir bem é meio caminho
...
- **visual:** Balança/proporção visual: 55 vs 5. Ou duas frases lado a lado (vaga vs específica) com a específica "acendendo". Ênfase tipográfica.

## Slide 17 — Fato x interpretação
...
- **visual:** Duas colunas: "FATO (o que a câmera vê)" vs "INTERPRETAÇÃO (a história que eu conto)" com pares de exemplos. Coluna de fato neutra, interpretação em tom de alerta.
...
## Slide 18 — Abertura do Movimento IV
- **title:** IV · Porquê
...
- **visual:** Abertura de movimento: "IV", "Porquê", subtítulo "Desça até a causa raiz".

## Slide 19 — Os 5 Porquês
...
- **visual:** Escada descendente animada: cada "Por quê?" desce um degrau, do sintoma ("máquina parada") até a raiz ("sem filtro"). Visual de profundidade.

## Slide 20 — Os 5 Porquês na locadora
...
- **visual:** Mesma escada do slide 19, agora com o conteúdo da locadora. Termina com a raiz destacada em âmbar: "a escala ignora o pico de sexta".

## Slide 21 — "Erro humano" é o começo, não o fim
...
- **visual:** Frase de Deming em destaque, grande. Abaixo, contraste: "culpar a pessoa" (beco sem saída) vs "consertar o sistema" (caminho). Tom firme.

## Slide 22 — Pergunta para a turma (Porquê)
...
- **visual:** Slide de pergunta, mesmo padrão do 13. Pergunta grande, borda âmbar.
...
## Slide 23 — Abertura do Movimento V
- **title:** V · Plano
...
- **visual:** Abertura de movimento: "V", "Plano", subtítulo "Decida e aja".

## Slide 24 — Nunca só uma opção
...
- **visual:** Uma bifurcação com 3 caminhos (A/B/C), cada um com um pequeno rótulo de custo/risco. Visual de encruzilhada.

## Slide 25 — Portas de uma ou duas vias
...
- **visual:** Duas portas: uma com seta dupla (↔, "volta atrás", verde/calma) e uma com seta única (→, "sem volta", âmbar/alerta). Regra abaixo de cada uma.

## Slide 26 — Bom o suficiente, agora
...
- **visual:** Relógio/ampulheta + frase "o ótimo é inimigo do feito". Talvez uma barra "qualidade vs tempo" mostrando o ponto de decisão (~80%).

## Slide 27 — Resolver sozinho ou escalar
...
- **visual:** Fluxo simples de decisão: "É sua alçada + reversível?" → resolve / escala. Caixinha destacando o "como escalar bem" (fato + causa + opções + recomendação).

---

# MOVIMENTO VI — PREVENIR
*Faça o problema não voltar. O salto de liderança.*

## Slide 28 — Abertura do Movimento VI
- **title:** VI · Prevenir
...
- **visual:** Abertura de movimento: "VI", "Prevenir", subtítulo "Faça o problema não voltar", com destaque visual diferente (é o clímax / salto de liderança).

## Slide 29 — Conserte o incidente E o sistema
...
- **visual:** Dois blocos lado a lado: "Incidente (hoje)" e "Sistema (sempre)", com seta indicando que prevenir = fazer os dois. O bloco "Sistema" em destaque.

## Slide 30 — Post-mortem sem culpa
...
- **visual:** Contraste: "Caça às bruxas" (medo, erros escondidos) vs "Post-mortem sem culpa" (verdade, sistema melhora). Referência sutil à aviação.

## Slide 31 — Cada problema, um processo melhor
...
- **visual:** Pequenas melhorias acumulando (degraus subindo, ou pontos virando uma linha ascendente). Pergunta-chave em destaque. Tom inspirador, mas sóbrio.

---

# FECHO

## Slide 32 — De volta ao exit gate
...
- **visual:** A cena do slide 2 reaparece, agora "anotada" com os 6 P em sequência ao lado de cada ação. Resolução visual: do vermelho/tensão para algo calmo.

## Slide 33 — Para a empresa, mas para a vida
...
- **visual:** Volta a frase-âncora e a tese em 3 frases. Os 6 P discretos no rodapé, como assinatura. Última tela: a pergunta final, sozinha, em âmbar sobre fundo escuro.

---

## Apêndice — fundamentação (fontes citadas)
- **5 Porquês / causa raiz** — Taiichi Ohno, *Sistema Toyota de Produção*.
- **"Todo sistema é perfeitamente desenhado..."** — W. E. Deming / Paul Batalden.
- **Separe a pessoa do problema** — Fisher & Ury, *Como Chegar ao Sim* (Harvard).
- **Rotular a emoção / negociação** — Chris Voss, *Negocie como se sua vida dependesse disso*.
- **Sequestro da amígdala** — Daniel Goleman, *Inteligência Emocional*.
- **OODA loop** — John Boyd.
- **Portas de uma/duas vias** — Jeff Bezos (cartas aos acionistas, Amazon).
- **Satisficing / decisão sob pressão** — Herbert Simon.
- **Decisão com 2+ opções** — Paul Nutt, pesquisa sobre decisões.
- **Escada de inferência** — Chris Argyris.
- **Post-mortem sem culpa / checklists** — Atul Gawande, *O Checklist*; cultura de aviação e SRE.
- **Kaizen / regra do escoteiro** — melhoria contínua (Toyota) / engenharia de software.
- **"55 minutos no problema"** — atribuída a Albert Einstein.
